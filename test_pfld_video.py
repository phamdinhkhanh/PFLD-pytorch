...
class PFLDLandmarkDetector(LandmarkDetectorAbstract):
    ...
    def get_68_landmarks(self, image):
        ...
        for l in landmarks:
            cv2.circle(image, (l[0], l[1]), 0, (255,0,0), -1)
        cv2.imshow("Landmark predict: ", image)
        return landmarks
...
def main():
    ...
    if args["model"] == "resnet101":
        ...
        pfld_backbone = MobileNetV3BackBone()
    ...
    while True:
        ...
        if img_org is not None:
            img = utils.resize_image(img_org, (fwidth, fheight))
...
# python3 test_pfld_video.py -i ./video/input/Le_Trung_Ngoc_Huyen_19970122_Female/11.extreme.mp4 -o ./video/output/Le_Trung_Ngoc_Huyen_19970122_Female/mobilenetv3/11.extreme.avi -m mobilenetv3 -p ./checkpoints_landmark/mobilenetv3/snapshot/checkpoint_epoch_395.pth.tar
# python3 test_pfld_video.py -i ./video/input/DMS_incar/FrontWheel_IR.mp4 -o ./video/output/DMS_incar/mobilenetv3/FrontWheel_IR.avi -m mobilenetv3 -p ./checkpoints_landmark/mobilenetv3/snapshot/checkpoint_epoch_64.pth.tar